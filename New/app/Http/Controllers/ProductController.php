        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($products)
               ...
               ->editColumn('product', function ($row) {
                ...
                ->addColumn(
                    'selling_price',
                    '<div style="white-space: nowrap;"><span class="display_currency" data-currency_symbol="true">{{round($min_price)}}</span> @if($max_price != $min_price && $type == "variable") -  <span class="display_currency" data-currency_symbol="true">{{$max_price}}</span>@endif </div>'
                )
