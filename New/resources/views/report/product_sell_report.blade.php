            ...
            <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        ...
                        <a href="#psr_detailed_with_margin_tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list" aria-hidden="true"></i> @lang('lang_v1.detailed_with_marging')</a>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="psr_detailed_tab">
                        ...
                        <div class="table-responsive">
                            ...
                            id="product_sell_report_table">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('sale.unit_purchase_price')</th>

                                        <th>@lang('sale.total_purchase_price')</th>

                                        <th>@lang('sale.unit_price')</th>

                                        <th>@lang('sale.unit_discount')</th>

                                        <th>@lang('sale.total_discount')</th>

                                        <th>@lang('sale.tax')</th>

                                        <th>@lang('sale.price_inc_tax')</th>

                                        <th>@lang('sale.profit_loss')</th>
                                ...
                                <tr>
                                    ...
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        ...
                                        <td><span class="display_currency" id="footer_total_purchase_price" data-currency_symbol ="true"></span></td>
                                        ...
                                        <td class="display_currency" id="footer_tax" data-currency_symbol ="true"></td>

                                    
                                        <td><span class="display_currency" id="footer_subtotal" data-currency_symbol ="true"></span></td>

                                        <td><span class="display_currency" id="footer_total_profit_loss" data-currency_symbol ="true"></span></td>
                            ...
                            <p class="text-muted">
                                ...
                                @lang('lang_v1.product_sell_note')
                    ...
                    <div class="tab-pane" id="psr_detailed_with_margin_tab">

                        <div class="table-responsive">

                            <table class="table table-bordered table-striped" 

                            id="product_sell_margin_table">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('sale.total_unit_price')</th>

                                        <th>@lang('sale.selling_price')</th>

                                        <th>@lang('sale.discount')</th>

                                        <th>@lang('sale.total_selling_price')</th>
                                ...
                                <tfoot>
                                    ...
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        ...
                                        <td id="footer_total_sold_margin"></td>

                                        <td></td>

                                        <td></td>

                                        <td id="footer_tax_margin"></td>

                                        <td></td>

                                        <td></td>

                                        <td><span class="display_currency" id="footer_subtotal_margin" data-currency_symbol ="true"></span></td>

                                        <td><span class="display_currency" id="footer_marging" data-currency_symbol ="true"></span></td>
                            ...
                            id="product_sell_grouped_report_table" style="width: 100%;">
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('report.total_discount')</th>
                                ...
                                <tfoot>
                                    ...
                                    <tr class="bg-gray font-17 footer-total text-center">
                                        ...
                                        <td><span class="display_currency" id="footer_grouped_discounttotal" data-currency_symbol ="true"></span></td>
